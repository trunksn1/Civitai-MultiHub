...
> Store installations update automatically. Version `0.13.0` is the current GitHub release;
...
Firefox updates the add-on automatically. The `0.13.0` package requests access to both Civitai
...
[Releases page](https://github.com/trunksn1/Civitai-MultiHub/releases), currently `v0.13.0`. Every
...
1. Under the `v0.13.0` release, download `civitai-multihub-full-v0.13.0.zip` and its `.sha256` file.
   Make sure the ZIP is an asset on the **Releases** page, not GitHub's automatic source archive.
   All `0.13.0` package variants include both Civitai domains.
